...
create table SAMLADDON_KEY_STORE (
    ...
    KEYSTORE_PASSWORD varchar2(100),
...
alter table SAMLADDON_SAML_CONNECTION add constraint FK_SAML_DEFAULT_GROUP foreign key (DEFAULT_GROUP_ID) references SEC_GROUP(ID)^
...
create index IDX_SAML_DEFAULT_GROUP on SAMLADDON_SAML_CONNECTION (DEFAULT_GROUP_ID)^
create index IDX_SAML_KEYSTORE on SAMLADDON_SAML_CONNECTION (KEYSTORE_ID)^
-- end SAMLADDON_SAML_CONNECTION
