...
import static com.haulmont.addon.saml.web.security.saml.SamlSessionPrincipal.SAML_CONNECTION_CODE;
...
public class SamlAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    protected void createSamlSession(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
    ...
    protected void cleanupSessionAttributes(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
